...
pipeline {
    ...
    agent {
        docker {
            ...
            args "-u 100:100 -v /var/lib/jenkins/.ssh:/var/lib/jenkins/.ssh -v /var/lib/jenkins/.kube:/var/lib/jenkins/.kube -v /tmp/k8s/${deploy_env}:/tmp"
        }
    }
...
def deployService(service, extraVars) {
    ...
    ansiblePlaybook(playbook: "deployments_uniq_te2_sre/playbook_uniq.yml",
         //   inventory: host+","  ,
            extraVars: extraVars)
}
