...
pipeline {
    ...
    agent {
        docker {
            ...
            alwaysPull true
            args "-u 0:0 -v /opt/jenkins/.ssh:/root/.ssh -v /opt/jenkins/.kube:/root/.kube -v /tmp/k8s/${deploy_env}:/tmp"
        }
    }
...
def deployService(service, extraVars) {
    ...
    ansiblePlaybook(playbook: "deployments_adidas_prod_sre/playbook_bym.yml",
         //   inventory: host+","  ,
            extraVars: extraVars)
}
