...
pipeline {
    ...
    agent {
        docker {
            ...
            alwaysPull true
            args "-u 0:0 -v /var/lib/jenkins/.ssh:/root/.ssh -v /var/lib/jenkins/.kube:/root/.kube -v /tmp/k8s/${deploy_env}:/tmp"
        }
    }
...
def deployService(service, extraVars) {
    ...
    ansiblePlaybook(playbook: "deployments_uniq_pe2_sre/playbook_uniq.yml",
         //   inventory: host+","  ,
            extraVars: extraVars)
}
